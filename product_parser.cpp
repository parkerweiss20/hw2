...
{
    Book *item = new Book(prodName_, price_, qty_, isbn_, author_);
    return item;
}
...
{
    Clothing *item = new Clothing(prodName_, price_, qty_, size_, brand_);
    return item;
}
...
{
    Movie *item = new Movie(prodName_, price_, qty_, genre_, rating_);
    return item;
}
